...
function reEnableButton(deleteButton) {
  ...
  var mug = document.getElementsByClassName("mug")[0];
  var bag = document.getElementsByClassName("bag")[0];
  var keytag = document.getElementsByClassName("keytag")[0];
  var umbrella = document.getElementsByClassName("umbrella")[0];
  ...
  if (cap.getElementsByClassName("product-name")[0].innerText == title) {
    ...
    mug.getElementsByClassName("product-name")[0].innerText == title
  ) {
    mug
      .getElementsByClassName("addtocart-wrapper")[0]
      .classList.remove("disabled-cursor");
    mug
      .getElementsByClassName("btn-addtocart")[0]
      .classList.remove("btn-disabled");
    mug.getElementsByClassName("btn-addtocart")[0].classList.add("btn");
    mug.getElementsByClassName("btn-addtocart")[0].innerHTML =
      '<i class="fas fa-shopping-cart"></i>Add to cart';
  } else if (
    bag.getElementsByClassName("product-name")[0].innerText == title
  ) {
    bag
      .getElementsByClassName("addtocart-wrapper")[0]
      .classList.remove("disabled-cursor");
    bag
      .getElementsByClassName("btn-addtocart")[0]
      .classList.remove("btn-disabled");
    bag.getElementsByClassName("btn-addtocart")[0].classList.add("btn");
    bag.getElementsByClassName("btn-addtocart")[0].innerHTML =
      '<i class="fas fa-shopping-cart"></i>Add to cart';
  } else if (
    keytag.getElementsByClassName("product-name")[0].innerText == title
  ) {
    keytag
      .getElementsByClassName("addtocart-wrapper")[0]
      .classList.remove("disabled-cursor");
    keytag
      .getElementsByClassName("btn-addtocart")[0]
      .classList.remove("btn-disabled");
    keytag.getElementsByClassName("btn-addtocart")[0].classList.add("btn");
    keytag.getElementsByClassName("btn-addtocart")[0].innerHTML =
      '<i class="fas fa-shopping-cart"></i>Add to cart';
  } else if (
    umbrella.getElementsByClassName("product-name")[0].innerText == title
  ) {
    umbrella
      .getElementsByClassName("addtocart-wrapper")[0]
      .classList.remove("disabled-cursor");
    umbrella
      .getElementsByClassName("btn-addtocart")[0]
      .classList.remove("btn-disabled");
    umbrella.getElementsByClassName("btn-addtocart")[0].classList.add("btn");
    umbrella.getElementsByClassName("btn-addtocart")[0].innerHTML =
      '<i class="fas fa-shopping-cart"></i>Add to cart'; 
  }	  
}
